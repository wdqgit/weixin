...
<form action="sendNews.do" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="author" class="form-control" id="firstname" 
				   placeholder="请输入作者"/>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="digest" class="form-control" id="firstname" 
				   placeholder="请输入描述">
		</div>
	</div>
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">跳转的地址：</label>
		<div class="col-sm-10">
			<input type="text" name="content_source_url" class="form-control" id="firstname" 
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<a href="list.do" class="btn btn-primary" role="button">返回</a>
		</div>
	</div>
